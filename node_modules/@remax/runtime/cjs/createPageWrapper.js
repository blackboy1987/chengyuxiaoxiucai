...
function createPageWrapper(Page, name) {
    ...
    return /** @class */ (function (_super) {
        ...
        function PageWrapper(props) {
            ...
            Object.keys(lifecycle_1.Lifecycle).forEach(function (phase) {
                var callback = lifecycle_1.callbackName(phase);
        ...
        PageWrapper.prototype.render = function () {
            ...
            if (isClassComponent_1.default(Page) || Page.$$typeof === ReactIs_1.ForwardRef) {
                props.ref = function (node) { return (_this.pageComponentInstance = node); };
            }
            return React.createElement(PageContext_1.default.Provider, { value: { page: this.props.page, modalContainer: this.props.modalContainer } }, React.createElement(WrappedPage, props));
        };
        return PageWrapper;
    }(React.Component));
}
exports.default = createPageWrapper;
