...
var usePageContext_1 = __importDefault(require("../hooks/usePageContext"));
function delay(ms) {
    if (typeof ms !== 'number') {
...
describe('ali remax render', function () {
    beforeEach(function () {
        __1.RuntimeOptions.apply({
            platform: types_1.Platform.ali,
        });
        instanceId_1.reset();
    });
    afterEach(function () {
        __1.RuntimeOptions.reset();
        instanceId_1.reset();
    });
...
describe('flatten update', function () {
    beforeAll(function () {
        __1.RuntimeOptions.apply({
            platform: types_1.Platform.wechat,
        });
    });
    afterAll(function () {
        __1.RuntimeOptions.reset();
...
it('usePageContext works', function (done) {
    var container = new Container_1.default(p);
    var modalContainer = new Container_1.default({});
    var Page = createPageWrapper_1.default(function () {
        var ctx = usePageContext_1.default();
        React.useEffect(function () {
            expect(ctx === null || ctx === void 0 ? void 0 : ctx.page).toBeDefined();
            expect(ctx === null || ctx === void 0 ? void 0 : ctx.modalContainer).toBe(modalContainer);
            done();
        }, []);
        return React.createElement(View_1.default, null);
    }, '');
    render_1.default(React.createElement(Page, { page: { data: {} }, query: {}, modalContainer: modalContainer }), container);
});
it('usePageInstance works', function (done) {
    var Page = createPageWrapper_1.default(function () {
        var instance = hooks_1.usePageInstance();
        React.useEffect(function () {
