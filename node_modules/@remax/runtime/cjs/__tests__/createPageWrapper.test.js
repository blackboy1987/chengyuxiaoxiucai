...
describe('createPageWrapper', function () {
    ...
    it('get Page ref', function () {
        ...
        var WrappedPage = createPageWrapper_1.default(Page, '');
        var testRenderer = react_test_renderer_1.default.create(React.createElement(WrappedPage, { page: null, query: {}, modalContainer: modalContainer }));
    ...
    it('get Page ref with HOC', function () {
        ...
        var WrappedPage = createPageWrapper_1.default(hoc(Page), '');
        var testRenderer = react_test_renderer_1.default.create(React.createElement(WrappedPage, { page: null, query: {}, modalContainer: modalContainer }));
        var instance = testRenderer.getInstance();
        expect(instance.pageComponentInstance).toBeInstanceOf(Page);
    });
    it('does not pass ref to FC', function () {
        ...
        var WrappedPage = createPageWrapper_1.default(FCPage, '');
        var testRenderer = react_test_renderer_1.default.create(React.createElement(WrappedPage, { page: null, query: {}, modalContainer: modalContainer }));
        var instance = testRenderer.getInstance();
