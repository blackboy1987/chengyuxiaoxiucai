...
it('usePageContext works', function (done) {
    ...
    var Page = createPageWrapper(function () {
        var ctx = usePageContext();
        React.useEffect(function () {
    ...
    render(React.createElement(Page, { page: { data: {} }, query: {}, modalContainer: modalContainer }), container);
});
it('usePageInstance works', function (done) {
    var Page = createPageWrapper(function () {
        var instance = usePageInstance();
        React.useEffect(function () {
