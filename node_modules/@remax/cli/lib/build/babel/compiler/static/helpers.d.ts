 ...
 */
export declare function isHostComponentElement(node: t.JSXElement | t.JSXFragment, path: NodePath<any>): boolean;
/**
 ...
 */
export declare function isPlainTextLeaf(node: t.Node, path: NodePath<any>): false | t.JSXAttribute | undefined;
/**
 * 用标签包裹当前 node
 */
 ...
 * 将标签替换为 <stub-block>
 */
export declare function replacedWithStubBlock(path: NodePath<any>): void;
/**
 * 判断是否是空的 JSXText
