...
exports.createTemplate = exports.templateInfoMap = void 0;
...
const TemplateInfoMap_1 = __importDefault(require("./TemplateInfoMap"));
exports.templateInfoMap = new TemplateInfoMap_1.default();
/**
 * 创建单个原生模板
 *
 * @param element
 ...
 * @returns {string}
 */
function createTemplate(api, element, path, dataPath) {
    if (t.isJSXElement(element.node)) {
        return JSXElement_1.default(api, element, path, dataPath, createTemplate);
    }
