...
exports.normalizeLiteral = exports.isEmptyText = exports.replacedWithStubBlock = exports.replacedWithJSXFragment = exports.wrappedByExpressionBlock = exports.wrappedByElement = exports.isPlainTextLeaf = exports.getTemplateID = exports.getLeafAttribute = exports.getAttributeByName = exports.isReactFragment = exports.isExpressionBlock = exports.isHostComponentElement = exports.getHostComponentName = void 0;
 ...
 */
function isHostComponentElement(node, path) {
 ...
 */
function isPlainTextLeaf(node, path) {
 ...
 * 将标签替换为 <stub-block>
 */
function replacedWithStubBlock(path) {
    path.replaceWith(t.jsxElement(t.jsxOpeningElement(t.jsxIdentifier(constants_1.STUB_BLOCK), []), t.jsxClosingElement(t.jsxIdentifier(constants_1.STUB_BLOCK)), [], true));
}
exports.replacedWithStubBlock = replacedWithStubBlock;
/**
 * 判断是否是空的 JSXText
